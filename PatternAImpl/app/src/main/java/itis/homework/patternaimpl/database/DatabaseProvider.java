...
public class DatabaseProvider extends ContentProvider {
    ...
    private static final int MESSAGES_TABLE = 1;

    private static final UriMatcher URI_MATCHER;

    static {
        URI_MATCHER = new UriMatcher(UriMatcher.NO_MATCH);
        URI_MATCHER.addURI(SqliteHelper.CONTENT_AUTHORITY, MessageContract.DatabaseRequests.TABLE_NAME, MESSAGES_TABLE);
    }
    ...
    public String getType(@NonNull Uri uri) {
        switch (URI_MATCHER.match(uri)) {
            case MESSAGES_TABLE:
                return MessageContract.DatabaseRequests.TABLE_NAME;
            default:
                return "";
        }
    }
